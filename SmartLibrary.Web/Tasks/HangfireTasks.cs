...
namespace SmartLibrary.Web.Tasks
{
    public class HangfireTasks
    {
        ...
        public async Task PrepareExpirationAlert()
        {
            var subscribers = _context.Subscribers
                ...
                .Where(s => !s.IsBlackList && s.Subscriptions.OrderByDescending(x => x.EndDate).First().EndDate == DateTime.Today.AddDays(5))
                .ToList();
                ...
                var placeholders = new Dictionary<string, string>()
            {
                    ...
                    var components = new List<WhatsAppComponent>()
                {
                    ...
                    var mobileNumber = _webHostEnvironment.IsDevelopment() ? "Add Your number" : subscriber.MobilePhone;
        ...
        public async Task RentalsExpirationAlert()
        {
            ...
            foreach (var rental in rentals)
            {
                ...
                var placeholders = new Dictionary<string, string>()
                {
                    { "imageUrl", "https://res.cloudinary.com/devagwa/image/upload/v1763189784/calendar_zfohjc_gtpwoq.png" },
