...
namespace SmartLibrary.Web.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var lastAddedBooks = _context.Books.Include(b =>b.Author).Where(b => !b.IsDeleted).OrderByDescending(b => b.Id)
                .Take(8).ToList();
            ...
            var viewModel = new DashboardViewModel
            {
                ...
                NumberOfSubscribers = numberOfCopies,
        ...
        [AjaxOnly]
        public IActionResult GetRentalPerDays(DateTime? startDate, DateTime? endDate)
        {
            startDate ??= DateTime.Today.AddDays(-29);
            endDate ??= DateTime.Today;
            var data = _context.RentalCopies.Where(c => c.RentalDate >= startDate && c.RentalDate <= endDate)
                .GroupBy(g => new { Date = g.RentalDate })
