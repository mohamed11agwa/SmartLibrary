...
namespace SmartLibrary.Web.Controllers
{
    ...
    .SingleOrDefault(r => r.Id == id);
        ...
        //        AllowExtend = !subscriber!.IsDeleted
        //            && subscriber!.Subscriptions.Last().EndDate >= rental.StartDate.AddDays((int)RentalsConfigurations.MaxAllowedCopies)
        ...
        //        else if (subscriber!.Subscriptions.Last().EndDate < rental.StartDate.AddDays((int)RentalsConfigurations.MaxAllowedCopies))
        ...
        //            currentCopy.EndDate = currentCopy.RentalDate.AddDays((int)RentalsConfigurations.MaxAllowedCopies);
        //            isUpdated = true;
        //        }
        //    }
        ...
        private (string errorMessage, int? maxAllowedCopies) ValidateSubscriber(Subscriber subscriber, int? rentalId = null)
        {
            ...
            var currentRentals = subscriber.Rentals.Where(r => rentalId == null || r.Id != rentalId)
                .SelectMany(r => r.RentalCopies).Count(c => !c.ReturnDate.HasValue);
