...
namespace SmartLibrary.Web.Data.Migrations
{
    ...
    [Migration("20251107074923_AddSubscribersAndGovernoratesAndAreasTables")]
    partial class AddSubscribersAndGovernoratesAndAreasTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.BookCategory", b =>
                {
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.Governorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.Area", b =>
                {
                    ...
                    b.HasOne("SmartLibrary.Web.Core.Models.Governorate", "Governorate")
                        .WithMany("Areas")
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.Book", b =>
                {
                    b.HasOne("SmartLibrary.Web.Core.Models.Author", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartLibrary.Web.Core.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("SmartLibrary.Web.Core.Models.Category", "Category")
                        .WithMany("BookCategories")
